...
Such methods usually require extensive training datasets and are computationally intensive. For the learning-based detection methods, we broadly classify the existing approaches into three categories based on the granularity of anomaly detection: (1) graph-based, (2) path-based, and (3) node-based. %, and (5) knowledge graph embedding-based.
